...
model_path = '.\\checkpoints\\checkpoint_acdc_100.pth'
...
save_path = '.\\temp\\acdc\\prediction\\prediction_unet'
...
def show_prediction_img(data, outputs, index):
...
for batch_idx, (data, target) in enumerate(test_dataloader):
    ...
    show_prediction_img(data, outputs, batch_idx)
